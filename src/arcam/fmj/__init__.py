...
APIVERSION_DTS_X_SERIES = set()
APIVERSION_DTS_X_SERIES.update(APIVERSION_860_SERIES)
APIVERSION_DTS_X_SERIES.update(APIVERSION_LEXICON_SERIES)
APIVERSION_DTS_X_SERIES.update(APIVERSION_HDA_SERIES)
...
APIVERSION_ROOM_EQUALIZATION_SERIES = set()
APIVERSION_ROOM_EQUALIZATION_SERIES.update(APIVERSION_450_SERIES)
APIVERSION_ROOM_EQUALIZATION_SERIES.update(APIVERSION_860_SERIES)
APIVERSION_ROOM_EQUALIZATION_SERIES.update(APIVERSION_LEXICON_SERIES)
APIVERSION_ROOM_EQUALIZATION_SERIES.update(APIVERSION_HDA_SERIES)
APIVERSION_ROOM_EQUALIZATION_SERIES.update(APIVERSION_SA_SERIES)

APIVERSION_SUBWOOFER_LIPSYNC_SERIES = set()
APIVERSION_SUBWOOFER_LIPSYNC_SERIES.update(APIVERSION_450_SERIES)
APIVERSION_SUBWOOFER_LIPSYNC_SERIES.update(APIVERSION_860_SERIES)
APIVERSION_SUBWOOFER_LIPSYNC_SERIES.update(APIVERSION_LEXICON_SERIES)
APIVERSION_SUBWOOFER_LIPSYNC_SERIES.update(APIVERSION_HDA_SERIES)
...
class CommandCodes(IntOrTypeEnum):
    ...
    ROOM_EQUALIZATION = 0x37, APIVERSION_ROOM_EQUALIZATION_SERIES
    ...
    SUBWOOFER_TRIM = 0x3F, APIVERSION_SUBWOOFER_LIPSYNC_SERIES
    LIPSYNC_DELAY = 0x40, APIVERSION_SUBWOOFER_LIPSYNC_SERIES
